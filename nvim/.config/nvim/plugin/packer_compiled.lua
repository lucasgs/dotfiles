...
_G.packer_plugins = {
  ...
  ["awesome-vim-colorschemes"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/awesome-vim-colorschemes",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
